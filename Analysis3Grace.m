...
dir_data = 'watergap22e_gswp3-w5e5_groundwstor_histsoc_monthly_1901_2019.nc';
...
figure(300); plot(decyr_tvec_4, ts_gws_LM_res/10)
ylabel('GWS [cm]')
grid on;
...
figure(200); plot(decyr_tvec_4, ts_gws_LM_res_vol)
ylabel('GWS [km^3]')
grid on;

%GLDAS_9mas = GLDAS_9mas( - ts_gws_LM_res_vol;
figure(1000); 

plot(t_GLDAS, mean(GLDAS_9mas')','*-'); grid on; hold on;
plot (GSFCx,GSFCy)
...
%fullGroundWater = ncread("watergap22e_gswp3-w5e5_ptotusegw_histsoc_monthly_1901_2019.nc");
