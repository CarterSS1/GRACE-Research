...
dir_data = 'watergap22e_gswp3-w5e5_glolakestor_histsoc_monthly_1901_2019.nc';
...
% GW 
gws_WGHM = ncread(dir_data,'glolakestor');  % unit: mm
...
ts_locwet_LM_res = ts_gws_LM - mean(ts_gws_LM);

figure(300); plot(decyr_tvec_4, ts_locwet_LM_res/10)
ylabel('GloLakeS [cm]')
grid on;
...
ts_locwet_LM_res_vol = (ts_locwet_LM_res/10)*1E-5*GSFCarea;


figure(200); plot(decyr_tvec_4, ts_locwet_LM_res_vol)
